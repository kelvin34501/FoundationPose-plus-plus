...
POSE_MIN_MASK_IOU="${POSE_MIN_MASK_IOU:-0.20}"
POSE_MAX_DEPTH_ERROR_M="${POSE_MAX_DEPTH_ERROR_M:-0.04}"
POSE_MIN_DEPTH_INLIER_FRACTION="${POSE_MIN_DEPTH_INLIER_FRACTION:-0.50}"
